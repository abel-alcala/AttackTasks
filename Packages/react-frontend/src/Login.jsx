...
import GoogleSignInPopup from './GoogleSignInPopup.jsx';
...
const Login = () => {
  ...
  const handleLogin = async (event) => {
    ...
    try {
      await api.storeCredentials(email, password);
        ...
        <div className="login-forms">
          <form onSubmit={handleLogin}>
            ...
            <div className="button-container">
              <button type="button" className="create-btn" onClick={() => navigate('/signup')}>
                Create account
              </button>
        ...
        {showError && (
            <>
              ...
              <div className="errorMessage">
                ...
                <a href="http://localhost:5174/login" >Got it</a>
              </div>
            </>
        )}
      </div>
